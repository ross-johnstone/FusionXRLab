...
namespace Recorder
{
    ...
    public class Recorder : MonoBehaviour
    {
        ...
        static private float clipLoudness;
        static private float[] clipSampleData;
        ...
        void Start()
        {
            ...
            audioSource.clip = Microphone.Start(Microphone.devices[0], true, 20, /*16000*/ 44100);
        ...
        private void Update()
        {
            ...
            Debug.Log(clipLoudness /= sampleDataLenght);
